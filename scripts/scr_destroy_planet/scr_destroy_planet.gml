function scr_destroy_planet(destruction_method) {
	...
	if (you.p_tyranids[baid]<5){
	    if (you.p_first[baid]=2) and (you.p_type[baid]="Hive") and (you.p_type[baid]!="Daemon") and (obj_controller.faction_status[eFACTION.Imperium]!="War"){
	        obj_controller.loyalty-=50;
	        obj_controller.loyalty_hidden-=50;
	    ...
	    if (you.p_owner[baid]=2) and ((you.p_type[baid]="Temperate") or (you.p_type[baid]="Temperate")) and (you.p_type[baid]!="Daemon"){
